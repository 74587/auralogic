...
// VirtualInventoryType 虚拟库存类型
type VirtualInventoryType string

const (
	VirtualInventoryTypeStatic VirtualInventoryType = "static" // 静态卡密库存
	VirtualInventoryTypeScript VirtualInventoryType = "script" // JS脚本动态发货
)
